...
public class ShowsToWatch extends ShowsBase {

    public ShowsToWatch() {
        setHasOptionsMenu(true);

        String filterOption = ShowEntry.COLUMN_SHOW_WATCHED;
        String[] filterOptionArgs = {"0"};
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        switch (curFilter) {
            ...
            case "not_released":
                ...
                break;
            default:
                Log.e("ShowsToWatch", "Filtering error");
                break;
        }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater){
        menu.clear();
        inflater.inflate(R.menu.menu_towatch,menu);
    }
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        switch (curSorting) {
            ...
            case "average_vote":
                ...
                break;
            default:
                Log.e("ShowsToWatch", "Sorting error");
                break;
        }
        ...
        switch (curSortingDirection) {
            ...
            case ("DESC"):
                ...
                break;
            default:
                Log.e("ShowsToWatch", "Sorting direction error");
                break;
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_sort_date:
                saveSortingBy(ShowEntry.COLUMN_SHOW_RELEASE_DATE_IN_MILLISECONDS);
                break;

            case R.id.menu_sort_rating:
                saveSortingBy(ShowEntry.COLUMN_SHOW_AVERAGE_VOTE);
                break;
    ...
    private void setFilterReleased() {
        String filterOption = ShowEntry.COLUMN_SHOW_WATCHED + "=? AND " +
                ShowEntry.COLUMN_SHOW_RELEASE_DATE_IN_MILLISECONDS + "<?";

        long currTimeMillis = System.currentTimeMillis();
        String[] filterOptionArgs = {"0", String.valueOf(currTimeMillis)};
